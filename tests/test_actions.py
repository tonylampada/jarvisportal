...
import sys
import subprocess
from actions import action_exec, action_createFile, action_updateFile, updateFileWithAnchors, set_cli_input
...
'''
    ...
    action_updateFile(filepath, 2, 4, 'I am a good file\nI have good content\n')
...
'''
    ...
    updateFileWithAnchors(filepath, start_anchor, end_anchor, new_content, inclusive=False)
...
# Remember to define the function updateFileWithAnchors as previously described before running this test.
